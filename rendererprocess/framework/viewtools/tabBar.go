...
func initializeTabBar() {
	...
	tabberTabBarLastPanel["mainMasterView_home_pad_CopyButton_CopyReadyPanel_tab_bar"] = "mainMasterView_home_pad_CopyButton_CopyReadyPanel_tab_bar-CopyWPMTabPanel"
	// the level is the tab bar id.
	tabberTabBarLastPanel["mainMasterView_home_pad_KeyButton_KeyReadyPanel_tab_bar"] = "mainMasterView_home_pad_KeyButton_KeyReadyPanel_tab_bar-KeyWPMTabPanel"
	// the level is the tab bar id.
	tabberTabBarLastPanel["mainMasterView_home_pad_ReferenceButton_SelectCodesPanel_tab_bar"] = "mainMasterView_home_pad_ReferenceButton_SelectCodesPanel_tab_bar-LettersTabPanel"
