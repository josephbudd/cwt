...
var (
	homeNames = []string{"ReferenceButton", "CopyButton", "KeyButton"}

	buttonNamePanelNames = map[string][]string{"CopyButton":[]string{"CopyNotReadyPanel", "CopyReadyPanel"}, "KeyButton":[]string{"KeyNotReadyPanel", "KeyReadyPanel"}, "ReferenceButton":[]string{"SelectCodesPanel"}}

	tabNamePanelNames = map[string][]string{"CopyPracticeTab":[]string{"CopyPracticePanel"}, "CopyTestTab":[]string{"CopyTestPanel"}, "CopyWPMTab":[]string{"CopyWPMPanel"}, "KeyPracticeTab":[]string{"KeyPracticePanel"}, "KeyTestTab":[]string{"KeyTestPanel"}, "KeyWPMTab":[]string{"KeyWPMPanel"}, "LettersTab":[]string{"LettersPanel"}, "NumbersTab":[]string{"NumbersPanel"}, "PunctuationTab":[]string{"PunctuationPanel"}, "SpecialTab":[]string{"SpecialPanel"}}

	panelNameButtonNames = map[string][]string{}

	panelNameTabNames = map[string][]string{"CopyReadyPanel":[]string{"CopyWPMTab", "CopyPracticeTab", "CopyTestTab"}, "KeyReadyPanel":[]string{"KeyWPMTab", "KeyPracticeTab", "KeyTestTab"}, "SelectCodesPanel":[]string{"LettersTab", "NumbersTab", "PunctuationTab", "SpecialTab"}}
)
