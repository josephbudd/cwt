...
func (group *panelGroup) defineMembers() (err error) {
 ...
 if panel = document.ElementByID("mainMasterView_home_pad_ReferenceButton_SelectCodesPanel_tab_bar-SpecialTabPanel-inner-SpecialPanel"); panel == nil {
	err = fmt.Errorf("unable to find #mainMasterView_home_pad_ReferenceButton_SelectCodesPanel_tab_bar-SpecialTabPanel-inner-SpecialPanel")
		return
    }
    group.specialPanel = panel.JSValue()
...
func (group *panelGroup) showSpecialPanel() {
	viewtools.ShowPanelInTabGroup(group.specialPanel)
}
