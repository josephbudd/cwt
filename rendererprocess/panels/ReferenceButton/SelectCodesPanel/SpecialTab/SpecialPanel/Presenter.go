...
func (presenter *panelPresenter) defineMembers() (err error) {
	...
	*/
	...
	if presenter.tableBody = document.ElementByID("specialsTableBody"); presenter.tableBody == nil {
		display.Error("unable to find specialsTableBody")
		return
	}
...
func (presenter *panelPresenter) initialFillTable(rr []*record.KeyCode) {
	...
	tr.AppendChild(th)
	th = document.NewTH()
	th.AppendText("@ WPM: Copy / Key % Correct")
