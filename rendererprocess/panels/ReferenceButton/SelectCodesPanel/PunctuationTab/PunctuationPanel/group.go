...
func (group *panelGroup) defineMembers() (err error) {
 ...
 if panel = document.ElementByID("mainMasterView_home_pad_ReferenceButton_SelectCodesPanel_tab_bar-PunctuationTabPanel-inner-PunctuationPanel"); panel == nil {
	err = fmt.Errorf("unable to find #mainMasterView_home_pad_ReferenceButton_SelectCodesPanel_tab_bar-PunctuationTabPanel-inner-PunctuationPanel")
		return
    }
    group.punctuationPanel = panel.JSValue()
...
func (group *panelGroup) showPunctuationPanel() {
	viewtools.ShowPanelInTabGroup(group.punctuationPanel)
}
