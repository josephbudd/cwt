...
func (group *panelGroup) defineMembers() (err error) {
 ...
 if panel = document.ElementByID("mainMasterView-home-pad-CopyButton-CopyNotReadyPanel"); panel == nil {
	err = fmt.Errorf("unable to find #mainMasterView-home-pad-CopyButton-CopyNotReadyPanel")
		return
    }
    group.copyNotReadyPanel = panel.JSValue()
 if panel = document.ElementByID("mainMasterView-home-pad-CopyButton-CopyReadyPanel"); panel == nil {
	err = fmt.Errorf("unable to find #mainMasterView-home-pad-CopyButton-CopyReadyPanel")
		return
    }
    group.copyReadyPanel = panel.JSValue()
...
// This panel's id is mainMasterView-home-pad-CopyButton-CopyNotReadyPanel.
...
func (group *panelGroup) showCopyNotReadyPanel(force bool) {
	viewtools.ShowPanelInButtonGroup(group.copyNotReadyPanel, force)
}

// showCopyReadyPanel shows the panel you named CopyReadyPanel while hiding any other panels in this panel group.
// That panel's id is mainMasterView-home-pad-CopyButton-CopyReadyPanel.
...
func (group *panelGroup) showCopyReadyPanel(force bool) {
	viewtools.ShowPanelInButtonGroup(group.copyReadyPanel, force)
}
