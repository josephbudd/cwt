...
func (controller *panelController) defineControlsReceiveEvents() (err error) {
	...
	*/
	var keyPracticeH, keyPracticeKey, keyPracticeCopy, keyPracticeStart, keyPracticeCheck, keyPracticeMetronomeOn js.Value
	...
	if keyPracticeMetronomeOn = notJS.GetElementByID("keyPracticeMetronomeOn"); keyPracticeMetronomeOn == null {
		err = errors.New("unable to find #keyPracticeMetronomeOn")
		return
	}

	// Define the keyWidget.
	controller.keyWidget = widgets.NewKeyWidget(keyPracticeH, keyPracticeStart, keyPracticeCheck, keyPracticeMetronomeOn, keyPracticeKey, keyPracticeCopy, controller.caller, controller.caller, tools, notJS)
