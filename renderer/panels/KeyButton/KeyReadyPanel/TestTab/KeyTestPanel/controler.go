...
func (panelControler *Controler) defineControlsSetHandlers() (err error) {
	...
	*/
	...
	panelControler.keyWidget = widgets.NewKeyWidget(keyTestH, keyTestStart, keyTestCheck, keyTestKey, keyTestCopy, panelControler.caller, panelControler.tools, notJS)
	return
}
