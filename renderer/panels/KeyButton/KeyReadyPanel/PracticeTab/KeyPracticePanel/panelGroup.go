...
func (panelGroup *PanelGroup) defineMembers() (err error) {
	...
	if panelGroup.keyPracticePanel = notJS.GetElementByID("tabsMasterView_home_pad_KeyButton_KeyReadyPanel_tab_bar-PracticeTabPanel-inner-KeyPracticePanel"); panelGroup.keyPracticePanel == null {
		err = errors.New("unable to find #tabsMasterView_home_pad_KeyButton_KeyReadyPanel_tab_bar-PracticeTabPanel-inner-KeyPracticePanel")
		return
	}
...
*/
func (panelGroup *PanelGroup) showKeyPracticePanel() {
	panelGroup.tools.ShowPanelInTabGroup(panelGroup.keyPracticePanel)
}
