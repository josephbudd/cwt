...
func Do(ctx context.Context, cargo interface{}, sending lpc.Sending, stores *store.Stores, errChan chan error) {
	...
	case *message.CheckCopyRendererToMainProcess:
		handleCheckCopy(ctx, cargo, sending, stores, errChan)
	case *message.CheckKeyRendererToMainProcess:
		handleCheckKey(ctx, cargo, sending, stores, errChan)
	case *message.GetCopyWPMRendererToMainProcess:
		handleGetCopyWPM(ctx, cargo, sending, stores, errChan)
	case *message.GetKeyCodesRendererToMainProcess:
		handleGetKeyCodes(ctx, cargo, sending, stores, errChan)
	case *message.GetKeyWPMRendererToMainProcess:
		handleGetKeyWPM(ctx, cargo, sending, stores, errChan)
	case *message.GetTextToCopyRendererToMainProcess:
		handleGetTextToCopy(ctx, cargo, sending, stores, errChan)
	case *message.GetTextToKeyRendererToMainProcess:
		handleGetTextToKey(ctx, cargo, sending, stores, errChan)
	case *message.KeyRendererToMainProcess:
		handleKey(ctx, cargo, sending, stores, errChan)
	case *message.MetronomeRendererToMainProcess:
		handleMetronome(ctx, cargo, sending, stores, errChan)
	case *message.UpdateCopyWPMRendererToMainProcess:
		handleUpdateCopyWPM(ctx, cargo, sending, stores, errChan)
	case *message.UpdateKeyCodeRendererToMainProcess:
		handleUpdateKeyCode(ctx, cargo, sending, stores, errChan)
	case *message.UpdateKeyWPMRendererToMainProcess:
		handleUpdateKeyWPM(ctx, cargo, sending, stores, errChan)
	default:
