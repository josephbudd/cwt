...
func handleGetTextToCopy(ctx context.Context, rxmessage *message.GetTextToCopyRendererToMainProcess, sending lpc.Sending, stores *store.Stores, errChan chan error) {
